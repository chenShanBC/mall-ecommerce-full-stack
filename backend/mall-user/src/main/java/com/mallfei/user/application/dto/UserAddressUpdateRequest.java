...
@Schema(name = "UserAddressUpdateRequest", description = "修改用户地址请求")
public record UserAddressUpdateRequest(
        @Schema(description = "收件人姓名", example = "Manual Receiver Updated")
        ...
        @Schema(description = "详细地址", example = "望京 SOHO T1 2002")
